...
* Adding Java interface.
* Adding file Analysis to work out file attributes from a sample file.
* Adding *Schema Walker* to allow user to generate there own code using just java.
