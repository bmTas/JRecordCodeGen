...
public interface IAmspodownloadSchema {
	public DefsAmspodownload.Records generatedRecordType();
	
	public IPoRecordUpd asPoRecord();
	
	public IProductRecordUpd asProductRecord();
	
	public ILocationRecordUpd asLocationRecord();
