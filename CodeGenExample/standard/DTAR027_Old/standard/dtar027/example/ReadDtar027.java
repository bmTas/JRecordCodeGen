...
public final class ReadDtar027 {
    ...
    public ReadDtar027() {
        ...
        try {
            ...
            FieldNamesDtar027.RecordDtar027 rDtar027 = FieldNamesDtar027.RECORD_DTAR027;
            AbstractLineReader reader = iob.newReader(dataFile);
            while ((line = reader.read()) != null) {
                lineNum += 1;
                System.out.println(
                              line.getFieldValue(rDtar027.keycodeNo).asString()
                      + " " + line.getFieldValue(rDtar027.qtySold).asString()
                      + " " + line.getFieldValue(rDtar027.salePrice).asString()
                   );
            }
